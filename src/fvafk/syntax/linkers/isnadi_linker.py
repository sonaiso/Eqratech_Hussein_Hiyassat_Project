"""
ISNADI Linker: Detects مبتدأ (subject) and خبر (predicate) relations

This module implements the IsnadiLinker which identifies nominal sentences
(الجملة الاسمية) and creates ISNADI links between مبتدأ and خبر.
...
class IsnadiLinker:
    ...
    in nominal sentences and creates directed links between them.
    ...
    Examples:
        >>> from fvafk.c2b.word_form import WordForm, PartOfSpeech, Case, Span
        >>> 
        >>> # الكتابُ مفيدٌ
        >>> words = [
        ...     WordForm(word_id=0, surface="الكتاب", span=Span(0, 6),
        ...              pos=PartOfSpeech.NOUN, case=Case.NOMINATIVE,
        ...              definiteness=True, number=Number.SINGULAR),
        ...     WordForm(word_id=1, surface="مفيد", span=Span(7, 11),
        ...              pos=PartOfSpeech.NOUN, case=Case.NOMINATIVE,
